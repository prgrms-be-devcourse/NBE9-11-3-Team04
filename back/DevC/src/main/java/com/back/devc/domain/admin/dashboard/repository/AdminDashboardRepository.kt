...
interface AdminDashboardRepository {
    ...
    fun countTodayPostReportsByReason(today: LocalDate?): MutableList<ReportReasonCount?>?
    ...
    fun countTodayCommentReportsByReason(today: LocalDate?): MutableList<ReportReasonCount?>?
}