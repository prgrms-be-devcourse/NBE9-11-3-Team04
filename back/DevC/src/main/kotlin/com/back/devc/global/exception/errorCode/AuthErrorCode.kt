...
enum class AuthErrorCode(
    ...
    TOKEN_MISSING(HttpStatus.UNAUTHORIZED, "AUTH_401_TOKEN_MISSING", "Access Token이 필요합니다."),
    TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "AUTH_401_TOKEN_EXPIRED", "Access Token이 만료되었습니다."),
    TOKEN_INVALID(HttpStatus.UNAUTHORIZED, "AUTH_401_TOKEN_INVALID", "유효하지 않은 Access Token입니다."),
