...
class NotificationController(
    ...
    fun getMyNotifications(
        ...
        @RequestParam(defaultValue = "all") tab: String,
    ): ResponseEntity<SuccessResponse<NotificationListResponse>> {
        ...
        val successCode = NotificationSuccessCode.NOTIFICATION_200_LIST
    ...
    ): ResponseEntity<SuccessResponse<NotificationResponse>> {
        val response = notificationService.readNotification(
            notificationId,
            getAuthenticatedUserId(authentication),
        )
        val successCode = NotificationSuccessCode.NOTIFICATION_200_READ
