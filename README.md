...
| 팀원 | 역할 |
| --- | --- |
| 김한솔 | 팀장 / 관리자 및 부가 기능 도메인 |
| 김태진 | 댓글 및 알림 도메인 / 외부 API 활용 AI / Github actions |
| 강지혜 | 게시글 도메인 |
| 박귀영 | 서기 / 상호작용 및 개인화 도메인 |
| 조보강 | 인증 도메인 / 프론트엔드 초기 세팅 / Docker & EC2 배포 |
...
----------------------------------------------------------------------------------
## 🎨 아키텍처 구조
<img width="1309" height="571" alt="image" src="https://github.com/user-attachments/assets/6c10b574-5a20-422e-be7b-8109e08548f3" />
